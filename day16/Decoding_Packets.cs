...
namespace day16
{
    public class Decoding_Packets
    {
        ...
        [Test]
        [TestCase("38006F45291200", 6, 2, 30)]
        [TestCase("EE00D40C823060", 3, 3, 6)]
    ...
    public record CompositeOperation(NodeId Id, params Node[] Children) : Node(Id)
    {
        public override long Evaluate()
        {
            return Children.Sum(x => x.Evaluate());
        }
    ...
    public class NibbleParser
    {
        ...
        private Node ParseLengthType0()
        {
            ...
            var node = new CompositeOperation(id, children.ToArray());
            return node;
        }
        ...
        private Node ParseLengthType1()
        {
            ...
            var node = new CompositeOperation(id, children);
            return node;
        }
